...
CaretakersListModel caretakersListModel(String str) =>
    CaretakersListModel.fromJson(json.decode(str));
...
class CaretakersListModel {
  ...
  factory CaretakersListModel.fromJson(Map<String, dynamic> json) =>
      CaretakersListModel(
...
class CaretakersListData {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "patient_reviews":
            List<dynamic>.from(patientReviews.map((x) => x.toJson())),
      };
}
...
final paymentStatusValues = EnumValues(
    {"pending": PaymentStatus.PENDING, "success": PaymentStatus.SUCCEEDED});

enum ServiceStatus { APPROVED, COMPLETED, PROCESSING, REQUESTED }
